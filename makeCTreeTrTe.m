function [ Sets , heights, triplets,SetsTest] = makeCTreeTrTe( data,inds, n0, h,dataTest,indsTest)
...
[S1,h1,tr1,S1Test] = makeCTreeTrTe(data(S1,:),inds(S1),n0,h+1,dataTest(S1Test,:),indsTest(S1Test));
[S2,h2,tr2,S2Test] = makeCTreeTrTe(data(S2,:),inds(S2),n0,h+1,dataTest(S2Test,:),indsTest(S2Test));
